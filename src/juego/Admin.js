...
import Navbar from "./componentes/Navbars/Navbar.js";
...
const switchRoutes = (
  <Switch>
    ...
    <Route path="/game/pokemon/:pokemonIndex" component={Pokemon} />
    <Redirect from="/game" to="/game/perfil" />
  </Switch>
);
...
export default function Admin({ ...rest }) {
  ...
  const getRoute = () => {
    return window.location.pathname !== "/game/maps";
  };
